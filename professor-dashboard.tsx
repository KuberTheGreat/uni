                      ...
                      <TableRow key={student.id}>
                        ...
                        <TableCell className="text-right">
                          ...
                          <Dialog>
                            ...
                            <DialogContent>
                              <DialogHeader>
                                <DialogTitle className="text-blue-900">Student Details</DialogTitle>
                              </DialogHeader>
                              <div className="space-y-4">
                                <div>
                                ...
                                <div className="space-y-3">
                                  ...
                                  <div className="flex justify-between items-center">
                                    ...
                                    <span className="font-medium">{student.midterm}/100</span>
                                  </div>
                                  <div className="flex justify-between items-center">
                                    <span className="text-sm">Quiz 1:</span>
                                    <span className="font-medium">{student.quiz1}/100</span>
                                  </div>
                                  <div className="flex justify-between items-center">
                                    <span className="text-sm">Quiz 2:</span>
                                    <span className="font-medium">{student.quiz2}/100</span>
                                  </div>
                                  <div className="flex justify-between items-center">
                                    <span className="text-sm">Assignment:</span>
                                    <span className="font-medium">{student.assignment}/100</span>
                                  </div>
                                  <Separator className="bg-blue-100" />
                                  <div className="flex justify-between items-center">
